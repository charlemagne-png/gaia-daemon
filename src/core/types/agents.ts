...
export interface AgentDef {
  ...
  avatarUrl?: string;
  icon: string;
  /** Voice-dispatch aliases for spoken routing. */
  aliases?: string[];
  /** Workspace id/name this agent should be redirected home to. */
  homeWorkspace?: string;
  /** Optional workspace scope metadata for account/import flows. */
  workspace?: string;
  voice?: string;
  ...
  /** Opt-in: summoned worker records one distilled self-episode. */
  selfEpisode?: true;
