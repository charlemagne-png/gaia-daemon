...
export interface RoomSummary {
  ...
  runningSince?: string;
  title?: string;
  /** The room's active agent, surfaced on room cards. */
  agent?: string;
...
export type UiEvent =
  ...
  | { type: "artifact-updated"; workspaceId: string; roomId: string; artifactId: string; projectId: string; version: unknown; manifest: unknown; inPlace?: boolean }
  ...
  | { type: "room-redirect"; workspaceId: string; roomId: string; fromWorkspaceId: string; fromRoomId: string; scope?: "source-room" | "workspace" }
