...
export interface WorkspaceConfig {
  ...
  /** GaiaVoice dispatcher config. */
  voice?: { dispatcherAgentId?: string; agentAliases?: Record<string, string>; dispatch?: { enabled?: boolean; stickySecs?: number; confidenceThreshold?: number } };
