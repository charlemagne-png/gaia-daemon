// FENCED FORK FEATURE — love + sanitize + rebirth.
// Owning commits: b77c298, 95335b0, 63c1624, 5861688.
// Rollback: move this module back to services/sanitize.ts; keep exported API unchanged.
