// FENCED FORK FEATURE — GaiaVoice app-native settings, stack, session, and bridge.
// Owning commits: 002b6d7, 3710c50, 3a81214, 392edab.
// Rollback: move this module back to services/voice.ts; keep exported API unchanged.
